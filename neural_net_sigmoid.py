...
print('\n2 layers (sigmoid):')
nn2_train_accuracy_sigmoid, nn2_test_accuracy_sigmoid = experiment(NN2_sigmoid())

print('\n2 layers (relu):')
nn2_train_accuracy_relu, nn2_test_accuracy_relu = experiment(NN2_relu())

# plot training accuracy

plt.plot(nn2_train_accuracy_sigmoid)
plt.plot(nn2_train_accuracy_relu)
plt.title('Activation function comparison (2 Layers): TRAINING ACCURACY')
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
plt.plot(nn2_test_accuracy_sigmoid)
plt.plot(nn2_test_accuracy_relu)
plt.title('Activation function comparison (2 Layers): TESTING ACCURACY')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['Sigmoid','ReLU'])
plt.show()
